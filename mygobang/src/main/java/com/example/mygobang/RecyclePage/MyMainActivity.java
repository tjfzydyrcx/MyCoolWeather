...
public class MyMainActivity extends AppCompatActivity  implements MyOnItemClickListener {
    ...
    static {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            music.imageId = R.mipmap.ic_launcher;
            music.title = "推荐歌单";
            mList.add(music);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ry);
